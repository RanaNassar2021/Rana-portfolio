  ...
  return (
    <>
      <Nav className="justify-content-start" activeKey="/home">
        <Nav.Item>
          <Nav.Link href="mailto: rana.nassar9925@gmail.com">  <i class="fa-solid fa-envelope fa-2x"></i></Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link  eventKey="link-1" href='https://github.com/RanaNassar-WD?tab=repositories' target="_blank" ><i class="fa-brands fa-square-github fa-2x"></i></Nav.Link>
        </Nav.Item>
        <Nav.Item>
